...
export class NavContentComponent implements OnInit {
  ...
  navMob() {
    ...
    if (navElement && this.windowWidth < 1025 && navElement.classList.contains('mob-open')) {
      ...
      console.warn("Element 'app-navigation.coded-navbar' not found in DOM.");
    }
  }
  

  // filepath: src/app/theme/layouts/admin-layout/nav-bar/nav-content/nav-content.component.ts
ngAfterViewInit() {
